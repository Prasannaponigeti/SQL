...
(5, 'Prassu', 'Ponigeti', 'prassu@example.com', 'Kansas');
...
ORDER_ID, AMOUNT,ORDER_DATE FROM CUSTOMERS
RIGHT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID;

-- RETURN ALL CUTOMERS ORDERS
...
SELECT CUSTOMERS.CUSTOMER_ID, CONCAT(FIRST_NAME, ' ', LAST_NAME) AS FULLNAME, COUNT(ORDERS.ORDER_ID) AS TOTAL_ORDERS
FROM CUSTOMERS
LEFT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID
...
-- FIND EACH CUSTOMERS TOTAL SPEND ON ORDERS
SELECT ORDERS.CUSTOMER_ID, CONCAT(FIRST_NAME, ' ', LAST_NAME) AS FULLNAME, SUM(AMOUNT) AS TOTAL_AMOUNT_SPEND
FROM CUSTOMERS
RIGHT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID
GROUP BY ORDERS.CUSTOMER_ID;

-- FIND EACH CUSTOMERS LAST ORDERED DATE
SELECT ORDERS.CUSTOMER_ID, CONCAT(FIRST_NAME, ' ', LAST_NAME) AS FULLNAME, MAX(ORDER_DATE) AS LATEST_ORDER_DATE
FROM CUSTOMERS
RIGHT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID
GROUP BY ORDERS.CUSTOMER_ID;
...
SELECT ORDERS.CUSTOMER_ID, CONCAT(FIRST_NAME, ' ', LAST_NAME) AS FULLNAME, MIN(ORDER_DATE) AS LATEST_ORDER_DATE
FROM CUSTOMERS
RIGHT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID
GROUP BY ORDERS.CUSTOMER_ID;

-- RETURN ALL CUSTOMERS DETAILS WHO PLACED MORETHAN ONE ORDER
SELECT CUSTOMERS.CUSTOMER_ID, CONCAT(FIRST_NAME, ' ', LAST_NAME) AS FULLNAME, COUNT(ORDERS.ORDER_ID) AS TOTAL_ORDERS
FROM CUSTOMERS
LEFT JOIN ORDERS
ON CUSTOMERS.CUSTOMER_ID = ORDERS.CUSTOMER_ID
